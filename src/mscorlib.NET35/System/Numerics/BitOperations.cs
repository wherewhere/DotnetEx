...
namespace System.Numerics
{
    ...
    public static class BitOperations
    {
        ...
        private static byte[] TrailingZeroCountDeBruijn => // 32
        [
        ...
        {
            return IntPtr.Size == 8 ? (nuint)RoundUpToPowerOf2((ulong)value) : RoundUpToPowerOf2((uint)value);
        }
        ...
        {
            return IntPtr.Size == 8 ? LeadingZeroCount((ulong)value) : LeadingZeroCount((uint)value);
        }
        ...
        {
            return IntPtr.Size == 8 ? Log2((ulong)value) : Log2((uint)value);
        }
        ...
        {
            return IntPtr.Size == 8 ? PopCount((ulong)value) : PopCount((uint)value);
        }
        ...
        {
            return IntPtr.Size == 8 ? TrailingZeroCount((ulong)(nuint)value) : TrailingZeroCount((uint)(nuint)value);
        }
        ...
        {
            return IntPtr.Size == 8 ? TrailingZeroCount((ulong)value) : TrailingZeroCount((uint)value);
        }
        ...
        {
            return IntPtr.Size == 8 ? (nuint)RotateLeft((ulong)value, offset) : RotateLeft((uint)value, offset);
        }
        ...
        {
            return IntPtr.Size == 8 ? (nuint)RotateRight((ulong)value, offset) : RotateRight((uint)value, offset);
        }
        ...
        private static class Crc32Fallback
        {
            ...
            private static uint[] Generate(uint reflectedPolynomial)
            {
