...
namespace System.Runtime.CompilerServices
{
    ...
    public readonly struct DefaultInterpolatedStringHandler
    {
        ...
        public DefaultInterpolatedStringHandler(int literalLength, int formattedCount, IFormatProvider? provider, StringBuilder initialBuffer)
        {
            _stringBuilder = initialBuffer;
            _provider = provider;
            _hasCustomFormatter = provider != null && HasCustomFormatter(provider);
        }
